...
Tutorial Link: http://www.codexworld.com/login-with-facebook-using-php/
...
4. Open the "config.php" file and modify the $appId, $appSecret, $return_url, $homeurl variables value.
