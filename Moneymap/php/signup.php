...
function NewUser()
 ...
 $password = hash('sha256', $_POST['pass']);
    echo $password;
 $activate=hash('sha256', $email);
 $link="http://localhost/moneymap/php/activate.php?email=$email&key=$activate";
 
 
 $query = "INSERT INTO websiteusers (fname,userName,email,pass,Activation) VALUES ('$fullname','$userName','$email','$password','$activate')"; 
